#!/usr/bin/env python
"""Cross-encoder trainer and scorer built on Qwen3-Reranker-8B.
...
Environment variables:
    ...
    WORKRB_Q_FULL_FT=1     full fine-tune instead of LoRA (needs the largest
                           available GPU; peak use is roughly 75 to 85 GB)
...
CFG = dict(key=CE_KEY, hf="Qwen/Qwen3-Reranker-8B",
